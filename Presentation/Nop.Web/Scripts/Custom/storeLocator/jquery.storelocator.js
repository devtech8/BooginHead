...
$.fn.storeLocator = function(options) {
  ...
  var settings = $.extend( {
      ...
      'distanceAlert': 60,
      'dataType': 'xml',
      'dataLocation': '../../Scripts/Custom/storeLocator/storeLocations.xml',
      'listColor1': 'ffffff',
      'listColor2': 'eeeeee',
      'originMarker': false,
      'originpinColor': 'blue',
      ...
      'infowindowTemplatePath': '../../Scripts/Custom/storeLocator/templates/infowindow-description.html',
      'listTemplatePath': '../../Scripts/Custom/storeLocator/templates/location-list-description.html',
      'KMLinfowindowTemplatePath': '../../Scripts/Custom/storeLocator/templates/kml-infowindow-description.html',
      'KMLlistTemplatePath': '../../Scripts/Custom/storeLocator/templates/kml-location-list-description.html',
